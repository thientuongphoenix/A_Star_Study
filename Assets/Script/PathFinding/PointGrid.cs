...
/// <summary>
/// Quản lý lưới điểm trong không gian 3D, tạo và duy trì các điểm có thể di chuyển được.
/// Class này chịu trách nhiệm tạo các điểm xung quanh chướng ngại vật và quản lý kết nối giữa các điểm.
/// </summary>
/// <remarks>
/// - Tự động tạo các điểm xung quanh chướng ngại vật khi khởi tạo
/// - Kiểm tra tính khả thi của đường đi giữa các điểm
/// - Cập nhật lưới điểm khi có chướng ngại vật mới được thêm vào
/// - Sử dụng Physics.Linecast để kiểm tra va chạm giữa các điểm
/// </remarks>
